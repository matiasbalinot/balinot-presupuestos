...
export const workers = mysqlTable("workers", {
  ...
  costPerDay: decimal("costPerHour", { precision: 10, scale: 2 }).notNull(),
  salePricePerDay: decimal("salePricePerHour", { precision: 10, scale: 2 }).notNull(),
...
export const projectTypes = mysqlTable("project_types", {
  ...
  avgSeoDays: decimal("avgSeoHours", { precision: 6, scale: 2 }).default("0"),
  avgDesignDays: decimal("avgDesignHours", { precision: 6, scale: 2 }).default("0"),
  avgDevDays: decimal("avgDevHours", { precision: 6, scale: 2 }).default("0"),
  avgVariousDays: decimal("avgVariousHours", { precision: 6, scale: 2 }).default("0"),
...
export const budgets = mysqlTable("budgets", {
  ...
  clientNif: varchar("clientNif", { length: 30 }),
  clientType: mysqlEnum("clientType", ["company", "person"]).default("company"),
  clientAddress: varchar("clientAddress", { length: 300 }),
  clientCity: varchar("clientCity", { length: 100 }),
  clientPostalCode: varchar("clientPostalCode", { length: 20 }),
  clientProvince: varchar("clientProvince", { length: 100 }),
  clientCountry: varchar("clientCountry", { length: 100 }).default("España"),
  clientPhone: varchar("clientPhone", { length: 30 }),
  clientWebsite: varchar("clientWebsite", { length: 200 }),
  projectTypeId: int("projectTypeId"),
  managementPct: decimal("managementPct", { precision: 5, scale: 2 }).default("40"),
  commissionType: mysqlEnum("commissionType", ["none", "luis", "commercial"]).default("none").notNull(),
  commissionPct: decimal("commissionPct", { precision: 5, scale: 2 }).default("10"),
  ...
  holdedServicePrice: decimal("holdedServicePrice", { precision: 10, scale: 2 }),
...
export const budgetLines = mysqlTable("budget_lines", {
  ...
  salePricePerDay: decimal("salePricePerHour", { precision: 10, scale: 2 }).default("0"),
...
export const projectHistory = mysqlTable("project_history", {
  ...
  projectName: varchar("projectName", { length: 200 }).notNull(),
  projectTypeId: int("projectTypeId"),
  realSeoDays: decimal("realSeoHours", { precision: 6, scale: 2 }).default("0"),
  realDesignDays: decimal("realDesignHours", { precision: 6, scale: 2 }).default("0"),
  realDevDays: decimal("realDevHours", { precision: 6, scale: 2 }).default("0"),
  realVariousDays: decimal("realVariousHours", { precision: 6, scale: 2 }).default("0"),
  realTotalDays: decimal("realTotalHours", { precision: 6, scale: 2 }).default("0"),
  estimatedTotalDays: decimal("estimatedTotalHours", { precision: 6, scale: 2 }).default("0"),
